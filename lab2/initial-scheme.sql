...
alter table country
    add constraint country_unique_name unique (name);
...
alter table contract
    add constraint date_check_contract check (start_date < end_date);
...
alter table player
    ...
    add constraint chk_date_of_birth check (date_of_birth > '1950-01-01');;
...
alter table position
    add constraint pos_name unique (name);
...
alter table competition
    add constraint date_check_comp check (start_date < end_date);
